...
async function importBankinter() {
  ...
  try {
    ...
    const response = await sendJSONgetJSON("/imports/from-bankinter", data);
...
document
  .querySelector("#bankinter-import")
  .addEventListener("click", importBankinter);
